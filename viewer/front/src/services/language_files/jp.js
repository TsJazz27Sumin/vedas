const get = () => {
    const word_dictionary = {
        ...
        "news8_2": "現時点で取得できるデータまで対応しています。",
        "news7_2": "東京電力のみ2020/08まで、北陸電力を除き、その他電力管内のデータは2020/07まで更新しています。",
        "news6_2": "東京電力のみ2020/07まで、北陸電力を除き、その他電力管内のデータは2020/06まで更新しています。",
        ...
        "jurisdiction": "管内",
        "watchout": "留意事項",
        "watchout_info1": "本アプリケーションの利用者が、本アプリケーションに依拠し、",
