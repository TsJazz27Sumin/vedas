const get = () => {
    const word_dictionary = {
        ...
        "how_to_use_text18": "九州電力管内では、太陽光で昼間の総需要の大半を補う日が出てきている。",
        "how_to_use_text19": "日本は、総需要の大半を火力依存でカバーしている。",
        "how_to_use_text20": "日本のグリーン電力（水力、地熱、バイオマス、太陽光、風力）の中では、水力と太陽光が強い。",
        "how_to_use_text21": "あなたのでんきについての「！」を見つけてみてください。",
