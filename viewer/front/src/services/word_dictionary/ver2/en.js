const get = () => {
    const word_dictionary = {
        ...
        "how_to_use_text18": "In Kyushu Electric Power's jurisdiction, there are days when sunlight makes up most of the total daytime demand.",
        "how_to_use_text19": "Japan covers most of its total demand on thermal power.",
        "how_to_use_text20": "In Japan's green electricity (hydro, geothermal, biomass, solar, wind), hydro and solar are strong.",
        "how_to_use_text21": "Try to find \"!\" About your electric power knowledge.",
