...
import ConditionDetailFirst from 'components/energycharts/atoms/ConditionDetailFirst'
import ConditionDetailSecond from 'components/energycharts/atoms/ConditionDetailSecond'
import ConditionDetailThird from 'components/energycharts/atoms/ConditionDetailThird'
...
const Condition = (props) => {
  ...
  const ConditionArea = StyledComponents.ConditionArea;
  const ConditionDetailMobileCaution = StyledComponents.ConditionDetailMobileCaution;
...
` ;
  ...
  return {
    ...
    ConditionDetailMobileCaution : ConditionDetailMobileCaution,
