...
const Chart = (props) => {
    ...
    return (
       ...
       <Line type="monotone" name={dict.solar_output_control} dataKey="solar_output_control" stroke="#8A6116" />
       <Line type="monotone" name={dict.wind} dataKey="wind" stroke="#B4E1FA" />
       <Line type="monotone" name={dict.wind_output_control} dataKey="wind_output_control" stroke="#573B00" />
