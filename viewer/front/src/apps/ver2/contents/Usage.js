...
const Usage = (props) => {
  ...
  const solar_sample1 = public_url + '/solar_sample/solar_sample1.png';
  const solar_sample2 = public_url + '/solar_sample/solar_sample2.png';
  const solar_sample3 = public_url + '/solar_sample/solar_sample3.png';
  const solar_sample4 = public_url + '/solar_sample/solar_sample4.png';
  const solar_sample5 = public_url + '/solar_sample/solar_sample5.png';
