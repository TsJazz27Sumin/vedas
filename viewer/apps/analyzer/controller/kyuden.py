...
class KyudenController(Controller):
    ...
    def correct_data(cls, root_path, reflesh):
        ...
        merged_pkl_path = KyudenService.correct_data(json['url'], root_path, reflesh)
    ...
    def check_download_page(cls, root_path):
        return CheckerFunction.check_download_page(root_path, cls.COMPANY_NAME, ['php', '</body>', '</html>', 'wheeling_disclosure'])
