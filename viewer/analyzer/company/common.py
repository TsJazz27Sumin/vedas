...
class CorrectFunction(object):
    ...
    ORIGINAL_FOLDER = f'data/{COMPANY_NAME_REPLACE_KEYWORD}/original'
    PROCESSED_FOLDER = f'data/{COMPANY_NAME_REPLACE_KEYWORD}/processed'
    MERGED_FOLDER = f'data/{COMPANY_NAME_REPLACE_KEYWORD}/merged'
    MERGED_CSV_FOLDER = f'data/{COMPANY_NAME_REPLACE_KEYWORD}/merged_csv'
